...
<div class="row">
  <div class="col-md-12">
    ...
    if (isset($_SESSION["product_updated"])) : ?>
      <p class="alert alert-info"><i class="fa fa-check"></i></p>
    <?php
      ...
      <div class="panel-body ">
        <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="index.php?action=updateproduct">
          <div class="form-group">
            ...
            <div class="col-lg-2">
              <input type="text" class="form-control" name="code" value="<?php echo $product->code; ?>" placeholder="Código">
            </div>
                  <label for="inputEmail1" class="col-lg-2 control-label">Precio</label>
                    <div class="col-lg-2">
                      <input type="text" class="form-control" name="precio" value="<?php echo $product->preciopost; ?>"  placeholder="Precio">
                    </div>
                    <label for="inputEmail1" class="col-lg-2 control-label">Marca</label>
                    <div class="col-lg-2">
                      <input type="text" class="form-control" name="marca" value="<?php echo $product->marca; ?>"  placeholder="Marca">
                    </div>
                    <br></br>
                    <p></p>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <textarea class="form-control" id="inputPassword1" placeholder="Descripción" rows="6" name="description"><?php echo $product->description; ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3">
              <div class="checkbox">
                <label>
                  <input type="checkbox" name="is_featured" <?php if ($product->is_featured) {
                                                              echo "checked";
                                                            } ?>> Producto destacado
                </label>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-4">
              <button type="submit" class="btn btn-danger btn-block">Actualizar Producto</button>
            </div>
          </div>
